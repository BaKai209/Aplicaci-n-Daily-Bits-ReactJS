...
export default class Questions1 extends Component {
  constructor() {
    super();
    this.state = {
      numberQuestion: 1,
  ...
  render() {
    return (
      <form className="container" onSubmit={this.handleSubmit}>
        ...
        <h2>Progreso: {this.state.numberQuestion}/{questionGames.length} </h2>
        <h2> Puntaje: {this.state.score}/{questionGames.length*4} </h2>
      </form>
    );
  }
}